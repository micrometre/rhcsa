...
help:
	...
	@echo ""
	@echo "  LVM targets:             (see makefiles/lvm.mk)"
	@echo "  lvm_setup              - Configure LVM (full setup)"
	@echo "  lvm_clean              - Remove LVM setup"
	@echo "  lvm_reconfigure        - Clean and reconfigure LVM"
	@echo "  lvm_install            - Install lvm2 package"
	...
	@echo "  lvm_format_mount       - Format db_lv with XFS and mount"
	@echo "  lvm_extend_lv          - Extend db_lv by 1G"
	@echo "  lvm_summary            - Show LVM summary"
	@echo "  lvm_add_hd             - Create and attach drive (vdc)"
	@echo "  lvm_prepare_vdc        - Initialize /dev/vdc as PV and add to data_vg"
	@echo "  lvm_pvmove             - Migrate data from vdb to vdc"
